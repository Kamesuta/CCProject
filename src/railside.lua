...
function isCan()
    ...
    while turtle.getItemCount(14) < 1 do Wait("Please set enderchest of Fence to the 14th slot") end
    --while turtle.getItemCount(16) < 1 do Wait("Please set enderchest of LED to the 16th slot") end
    while turtle.getItemCount(15)  < 1 do Wait("Please set enderchest of Coal to the 15h slot") end
    ...
    while not isMaterials("B") do
        Wait("Set Fence into ender chest!")
    end--[[
    ...
    if turtle.getItemCount(16) ==0 then
        while not LoadMaterials(16,1,15) do Wait("Set Fuel items into ender chest!") end
    end
